...
def recording():
    ...
    #global p, frames, CHUNK, FORMAT, CHANNELS, RATE, dev_index, WAVE_OUTPUT_FILENAME
    CHUNK = 8192
    ...
    class MyListener(keyboard.Listener):
        def __init__(self):
            global FORMAT, CHANNELS, RATE, WAVE_OUTPUT_FILENAME
    ...
    def recorder():
        started = False
        stream = None
        global p, frames, CHUNK, FORMAT, CHANNELS, RATE, dev_index
